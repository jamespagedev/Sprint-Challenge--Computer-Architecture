...
void alu_and(struct cpu *cpu, unsigned char IR, int num_operands, unsigned char *operands)
{
  if (DEBUGGER)
  {
    print_ir_bin_hex_dec(IR);
    printf("\n");
    printf("AND Operand(s):\n");
    printf("Num of operands = %d\n", num_operands);
    printf("Operand 1 = %d\n", operands[0]);
    printf("Operand 2 = %d\n", operands[1]);
  }

  alu(cpu, ALU_AND, operands[0], operands[1]);
  cpu->PC += (num_operands + 1);
...
void alu_or(struct cpu *cpu, unsigned char IR, int num_operands, unsigned char *operands)
{
  if (DEBUGGER)
  {
    print_ir_bin_hex_dec(IR);
  ...
  alu(cpu, ALU_OR, operands[0], operands[1]);
  cpu->PC += (num_operands + 1);
...
void alu_xor(struct cpu *cpu, unsigned char IR, int num_operands, unsigned char *operands)
{
  if (DEBUGGER)
  {
    print_ir_bin_hex_dec(IR);
    printf("\n");
    printf("XOR Operand(s):\n");
    printf("Num of operands = %d\n", num_operands);
    printf("Operand 1 = %d\n", operands[0]);
    printf("Operand 2 = %d\n", operands[1]);
  }
...
void alu_shl(struct cpu *cpu, unsigned char IR, int num_operands, unsigned char *operands)
{
  if (DEBUGGER)
  {
    print_ir_bin_hex_dec(IR);
    printf("\n");
    printf("SHL Operand(s):\n");
    printf("Num of operands = %d\n", num_operands);
    printf("Operand 1 = %d\n", operands[0]);
    printf("Operand 2 = %d\n", operands[1]);
  }
